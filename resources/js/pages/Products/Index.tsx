                                        ...
                                        {[1,2,3,4,5,6].map((i) => {
                                            ...
                                            return product[key] ? (
                                                <div key={i} className="relative">
                                                    <img src={product[key] as string} alt={`Image ${i}`} className="w-10 h-10 object-cover rounded border shadow-sm" />
                                                    {viewCount > 0 && (
                                                        <span className="bg-red-500 absolute px-1 py-0 top-[2%] right-0 text-[10px] text-white font-bold rounded-sm leading-tight">
                                                            {viewCount}
                                                        </span>
                                                    )}
                                                </div>
